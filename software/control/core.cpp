...
bool Core::sendEnableFrontDistanceSensorCommand()  { return writeToSCR(SCR_CMD_ENABLE_FRONT_SENSOR, 3);             }
bool Core::sendDisableFrontDistanceSensorCommand() { return writeToSCR(SCR_CMD_DISABLE_FRONT_SENSOR, 3);            }
